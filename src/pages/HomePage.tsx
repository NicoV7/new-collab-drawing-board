      ...
      <div className="max-w-2xl w-full space-y-8 p-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Create and collaborate on drawings in real-time with friends and colleagues
          </p>
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Easy Room Sharing</p>
                    <p className="text-sm text-gray-500">Share rooms with simple codes</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Guest Access</p>
                    <p className="text-sm text-gray-500">No account required to start</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Save Your Work</p>
                    <p className="text-sm text-gray-500">Account holders can save drawings</p>
                  </div>
                </div>
              </div>
            </div>
